...
pipeline =  AutoPipelineForInpainting.from_pretrained("Sanster/PowerPaint-V1-stable-diffusion-inpainting", cache_dir = CACHE_DIR_SHARED,  torch_dtype=torch.float16).to(device)
