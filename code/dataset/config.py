...
pipeline =  AutoPipelineForInpainting.from_pretrained('JunhaoZhuang/PowerPaint_v2/realisticVisionV60B1_v51VAE', cache_dir = CACHE_DIR_SHARED,  torch_dtype=torch.float16).to(device)
