...
def get_coco_image_data(data, img_name = None):
        ...
        target_segmentation = augment_area_within_bounds(target_segmentation, 1.30, max_w, max_h)
...
def generate_new_image(data, n):
    ...
    for i, set in enumerate(sets):
            ...
            generated_image, square_mask_image = git p(pipe, upscaled_image, upscaled_bbox, images_names[0], scene_category, prompt_obj_descr)
            # save the image
